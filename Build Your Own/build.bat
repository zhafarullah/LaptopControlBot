...
if "%USE_ICON%"=="1" (
    ...
    call build_venv\Scripts\python.exe -m PyInstaller --onefile --noconsole --name "LaptopControlBot" --icon=icon.ico --add-data "config.py;." --add-data "modules;modules" --hidden-import "modules" --hidden-import "telegram" --hidden-import "PIL" --hidden-import "cv2" --hidden-import "psutil" --hidden-import "win32gui" main.py && (
